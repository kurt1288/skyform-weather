...
defineEmits(['viewChange', 'open-settings']);
</script>

<template>
  <footer>
    <div class="footer">
      <button type="button" @click="$emit('viewChange', 'forecast')">
        <svg
